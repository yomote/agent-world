...
| 簡略化して再利用       | `docs/adr/template.md`, `docs/documentation/strategy.md`, `docs/runbooks/local-fullstack-dev.md`                                         | 製品・インフラの構造判断はADR、開発・運用判断は専用文書、手順はrunbook、APIの正典はPydantic。MDX・生成図・文書管理自動化は不要    |
