...
追補 (2026-09-13): この文書は最初のVertical Sliceを作った時点の移植判断として保持する。現行デモの配置は [ADR 0011](adr/0011-demo-directory-layout.md) と [resident-move README](../demos/resident-move/README.md) を参照する。
