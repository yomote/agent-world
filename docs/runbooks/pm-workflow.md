...
デモや利用者価値を扱うwork itemは、実装前に短い課題提案をPOへ示します。提案には、誰がどの場面で困るか、現在の対応と負担、何を肩代わりするか、代表的な入力から結果までの1例、人がどう楽になるか、通常のcodeで担う部分とAIで試す仮説を含めます。wireや操作説明だけで課題・価値の説明を代替せず、POとその認識を合わせてから着工します。
